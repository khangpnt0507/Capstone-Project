...
var
	...
	markersData = {
			...
			},
			{
				...
				map_image_url: 'resources/img/img3.png',
				name_point: 'Envato',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: '02.html'
			},
			{
				...
				map_image_url: 'resources/img/img4.png',
			...
			'Cinema': [
			{
				name: 'CGV Cinemas Vincom Pham Ngoc Thach',
				location_latitude: 21.023272, 
				location_longitude: 105.809256,
				map_image_url: 'resources/img/img.png',
				name_point: 'CGV Cinemas Vincom Pham Ngoc Thach',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: '02.html'
			},
			{
