...
<!--Adaptive styles-->
<link rel="stylesheet" type="text/css"
	href="../resources/css/adaptive.css">
<!--Swipe menu-->
			...
			<section class="contact" id="contact">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h2>
								Confirm Place<i class="fa fa-paper-plane-o"></i>
							</h2>
						</div>
					</div>
					<div id="map-canvas"></div>
					<div class="row">
						<form method="post" action="/tas/confirmPlace" name="contactform"
							id="contactform">
							<div class="col-md-6">

								<fieldset>
									<input id="latitude" name="latitude" type="text" id="latitude"
										size="30" placeholder="Lattitude"
										value="${ listPlaceTemp.latitude}"> <br> <input
										id="longitude" name="longitude" type="text" id="longitude"
										size="30" placeholder="Longitude"
										value="${ listPlaceTemp.longitude}"> <br> <input
										name="name" type="text" id="name" size="30"
										placeholder="Place name" value="${ listPlaceTemp.name}">
									<br> <input name="homepage" type="text" id="homepage"
										size="30"
										placeholder="Home page or facebook page of this place"
										value="${ listPlaceTemp.homepage}"> <br> <input
										name="workinghours" type="text" id="workinghours" size="30"
										placeholder="Working hours"> <br>  <input
										name="phone" type="number" id="phone" size="30"
										placeholder="Contact number"> <br>
								</fieldset>
							</div>
							<div class="col-md-6">
								<fieldset>
									<input id="address" name="address" type="text" id="address"
										size="30" placeholder="No, Street,..."> <br> <select
										...
										<option value="Hai Ba Trung">Ha Ba Trung</option>
									...
									</select> <br> <select name="category_ID" id="category_ID">
										...
										<option value="7">Heritage</option>
										<option value="8">Park</option>
										<option value="9">Shopping center</option>

									</select> <br> <input name="price" type="text" id="price" size="30"
										placeholder="Average Price "> <br>
