					...
					<div class="panel panel-default panel-table">
						<div class="panel-heading">
							<div class="row">
								<div class="col col-xs-6">
									<h3 class="panel-title">Temporarily place panel</h3>
								</div>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered table-list">
								...
								<tbody>
									<c:forEach var="list" items="${listPT}">
										<tr>
											<td align="center"><a
												href="confirmplace/${list.placetemp_id}"
												class="btn btn-default"><em class="fa fa-pencil"></em></a> <a
												href="deletePlaceTemp/${list.placetemp_id}"
												class="btn btn-danger"><em class="fa fa-trash"></em></a></td>

											<td>${list.placetemp_id}</td>
											<td>${list.name}</td>
							...
							<div class="row">
								...
								<div class="col col-xs-8">
									<ul class="pagination hidden-xs pull-right">
										<li><a href="/tas/viewplacetemp/1">1</a></li>
										<li><a href="/tas/viewplacetemp/2">2</a></li>
										<li><a href="/tas/viewplacetemp/3">3</a></li>
										<li><a href="/tas/viewplacetemp/4">4</a></li>
										<li><a href="/tas/viewplacetemp/5">5</a></li>
									</ul>
